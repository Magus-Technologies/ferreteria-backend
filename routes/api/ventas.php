...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ============================================
    Route::apiResource('transferencias-stock', \App\Http\Controllers\TransferenciaStockController::class)->only(['index', 'store', 'update', 'destroy'])->middleware('broadcast:transferencias-stock');

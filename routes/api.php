...
Route::middleware("auth:sanctum")->group(function () {
    ...
    Route::prefix("usuarios")->group(function () {
        Route::get("/vendedores-disponibles", [
    ...
    Route::prefix("configuracion-impresion")->group(function () {
        Route::get("/{tipo_documento}", [
            ConfiguracionImpresionController::class,
            "index",
        ]);
        Route::get("/{tipo_documento}/{campo}", [
            ConfiguracionImpresionController::class,
            "show",
        ]);
        Route::put("/{tipo_documento}/{campo}", [
            ConfiguracionImpresionController::class,
            "update",
        ]);
        Route::put("/{tipo_documento}", [
            ConfiguracionImpresionController::class,
            "updateMultiple",
        ]);
        Route::post("/{tipo_documento}/{campo}/reset", [
            ConfiguracionImpresionController::class,
            "resetCampo",
        ]);
        Route::post("/{tipo_documento}/reset-all", [
            ConfiguracionImpresionController::class,
            "resetAll",
        ]);
    });
    ...
    Route::prefix("restrictions")->group(function () {
        ...
        Route::prefix("roles")->group(function () {
            Route::get("/", [RestrictionController::class, "roles"]);
            Route::get("/{roleId}", [RestrictionController::class, "getRole"]);
            Route::post("/{roleId}/restrictions", [
                RestrictionController::class,
                "assignRestrictionsToRole",
            ]);
            Route::post("/{roleId}/toggle", [
                RestrictionController::class,
                "toggleRestrictionForRole",
            ]);
        });

        // Verificar acceso de usuarios
        Route::prefix("users")->group(function () {
            Route::post("/{userId}/check-access", [
                RestrictionController::class,
                "checkAccess",
            ]);
        });

...
X MIS COMPRAS - CUANDO PONGO DEFRENTE FINALIZAR RECEPCION NO SE MUESTAR EN MIS RECEPCIONES
...
X ORDENES DE COMPRAS- IMPLEMENTAR IMPRESION
...
X MIS ORDENES DE COMPRA - DUPLICAR (REPLICAR LA LOGICA DE DUPLICAR PRODUCTOS EN MI ALMACEN)
...
X AGREGAR TAPS SOLICITUD DE ORDENES DE COMPRA Y TABLA DE REQUERIEMIENTO DE SERVICIOS

X KARDEX - BUSCADOR EN TIEMPO REAL

X KARDEX - CORREGIR DATOS JALADOS DE KARDEX INVENTARIO Y FACTURACION 

X KARDEX - STOCK ACTUAL, STOCK ANTERIOR, CUANTO INGRESO

...
class ConfiguracionImpresionController extends Controller
{
    ...
    public function updatePlantilla(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'mensajes_extra.ocultar_logo' => 'nullable|boolean',
            'mensajes_extra.ocultar_canjear' => 'nullable|boolean',
            'mensajes_extra.ocultar_despedida' => 'nullable|boolean',
            'mensajes_extra.ocultar_cuentas_bancarias' => 'nullable|boolean',

...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('transferencias_efectivo_vendedores', function (Blueprint $table) {
            ...
            $table->char('vendedor_origen_id', 26);
            $table->integer('sub_caja_origen_id')->nullable()->comment('Sub-caja de donde sale el dinero');
            $table->char('vendedor_destino_id', 26);
            $table->integer('sub_caja_destino_id')->nullable()->comment('Sub-caja donde entra el dinero');
